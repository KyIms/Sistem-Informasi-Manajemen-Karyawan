...
// jumlah guru
$jumlahGuru = mysqli_num_rows(mysqli_query($con, "SELECT * FROM tb_karyawan WHERE id "));
...
<head>
    ...
    <title>Administrator | Dicky Imam Sobari</title>
        ...
        <div class="main-header">
            ...
            <div class="logo-header" data-background-color="blue">
                <a href="dashboard.php" class="logo">
                    <img src="../assets/img/logo_Univ.png" alt="navbar brand" class="navbar-brand" width="150">
                </a>
            ...
            <div class="content">
				...
				if ($page == 'menu') {
					...
					elseif ($act == 'absensi') {
						...
						include 'modul/menu/jabatan/showData.php';
						// Izin
					} elseif ($act == 'izin') {
            ...
            <footer class="footer">
                <div class="container">
                    <div class="copyright ml-auto">
                        &copy;
                        <?php echo date('Y'); ?><a href="#" target="_blank"> KyIms</a>
                    </div>
                </div>
            </footer>
        </div>
